...
const Layout_1 = __webpack_require__(/*! ../../../src/ts/layouts/Layout */ "./src/ts/layouts/Layout.ts");
const swiper_1 = __webpack_require__(/*! swiper */ "./node_modules/swiper/swiper.mjs");
...
class Main {
    constructor() {
        $(this.init);
        (0, debug_1.l)('Main() - Wait for dom loaded');
    }
    init() {
        (0, debug_1.l)('   Dom loaded. Init site.');
